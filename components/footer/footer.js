  ...
  return (
    <footer className="relative py-20 flex flex-col items-center bg-dark overflow-hidden md:py-10 mt-20">
          ...
          <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
            <div className="w-full space-x-12 flex justify-center text-white sm:w-7/12 md:justify-start">
              <ul className="list-disc list-inside space-y-8">
                <h1 className="text-center font-bold uppercase underline">
                  Links
                </h1>
                <li>
                  <Link className="hover:text-secondary transition" href="/">
                    Home
                  </Link>
                </li>
      ...
      >
        <div
          aria-hidden="true"
          className="bg-layers bg-scale w-56 h-56 m-auto blur-xl bg-gradient-to-r from-white via-dark to-secondary rounded-full md:w-[30rem] md:h-[30rem] md:blur-3xl"
        ></div>
      </div>
      <div
        aria-hidden="true"
